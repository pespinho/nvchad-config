    ...
    init = function()
      ...
      lsp.on_attach(
        function(client, bufnr)
          ...
          vim.keymap.set("n", "gi", function() vim.lsp.buf.implementation() end, { desc = "LSP implementation" })
          vim.keymap.set("n", "<leader>ls", function() vim.lsp.buf.signature_help() end, { desc = "LSP signature help" })
          vim.keymap.set("n", "<leader>D", function() vim.lsp.buf.type_definition() end, { desc = "LSP definition help" })
          vim.keymap.set("n", "<leader>ra", function() require("nvchad_ui.renamer").open() end, { desc = "LSP rename" })
          ...
          vim.keymap.set("n", "<leader>dp", function() vim.diagnostic.goto_prev { float = { border = "rounded" } } end,
            { desc = "Goto prev" })
          vim.keymap.set("n", "<leader>dn", function() vim.diagnostic.goto_next { float = { border = "rounded" } } end,
            { desc = "Goto next" })
